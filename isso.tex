...
\begin{document}
\name{Daniel Jiménez}
\tagline{Senior Data Scientist, Machine Learning engineer}
% Cropped to square from https://en.wikipedia.org/wiki/Marissa_Mayer#/media/File:Marissa_Mayer_May_2014_(cropped).jpg, CC-BY 2.0
\photo{2.5cm}{photo}
\personalinfo{%
  % Not all of these are required!
  % You can add your own with \printinfo{symbol}{detail}
  \email{azhwinraj@gmail.com}
    \phone{6382496623}
  \location{TamilNadu, India}
  
   \linkedin{www.linkedin.com/in/azhwinraj}
    \twitter{@azhwinraj}
   \github{github.com/azhwinraj} % I'm just making this up though.
...
\cvevent{ Automatic Watertank Filling System using Arduino}{}{Apr 2018}{}
\begin{itemize}
...
\cvevent{Analysis On Agriculture Of Tamil Nadu}{}{Jan 2019 }{}
\begin{itemize}
...
\cvevent{1000 Words - Journal Application}{}{June 2019 -- Ongoing}{}
\begin{itemize}
...
\cvachievement{\faTrophy}{19th NATIONAL SENIOR FOOTBALL CHAMPIONSHIP}{To Lead TamilNadu to a 4th Place Finish at 19th NATIONAL SENIOR FOOTBALL CHAMPIONSHIP at Mapusa,Goa}

\divider

\cvachievement{\faTrophy}{8th NATIONAL SENIOR FOOTBALL TENNIS CHAMPIONSHIP}{Be a part of the TamilNadu Team at 8th NATIONAL SENIOR FOOTBALL TENNIS CHAMPIONSHIP at Dhenkanal,Odisha}

\divider

\cvachievement{\faHeartbeat}{CODER'S PREMIER LEAGUE}{ Finish 4th in a 24-hour coding contest ny Soliton Technologies}
